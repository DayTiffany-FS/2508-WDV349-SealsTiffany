...
export default function AboutPage() {
  return (
    <>
      <Helmet>
        <title>About Off Ramp | Who Is Off Ramp</title>
        <meta
          name="description"
          content="Learn about Off Ramp and its members."
        />
      </Helmet>
      ...
      <main>
        <section>
          ...
          <div className="influence-part">
            <h4>Influences include:</h4>
            <p>
              The Beatles, Fleetwood Mac, Bruno Mars, and local Georgia legends.
              Our goal is always to get the crowd moving and singing along.
            </p>
          </div>
        </section>
      </main>
