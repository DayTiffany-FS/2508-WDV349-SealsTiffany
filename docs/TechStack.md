...
*I plan to start in Figma to create basic, clickable designs to work from and model in production.
*React will be my primary source for building my UI as it is what I am most familiar and comfortable manipulating to suit my needs. I plan to do some research to potentially use different component libraries to enhance this.
*I have not fully decided how to implement CSS styling for my UI yet and will continue to develop this as I build the project.
...
*The main component of my front end will be React due to efficient rendering and the accessibility of different component libraries.
*CSS styling will be used to enhance the user experience.
...
*React's Context API will manage the application level.
*MongoDB will hold server-side data. Both are chosen due to my recent use of these.
...
*Node will serve as my backend runtime environment allowing me to manage API requests and responses.
...
*Express will allow me to handle middleware for parsing, routing each section, and managing logic through controllers.
