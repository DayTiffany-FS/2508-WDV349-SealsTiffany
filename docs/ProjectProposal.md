...
This will be a promotional site for a band local to me. The site will allow them to promote their upcoming shows, display pictures and videos, give information about the band and booking, and allow people to contact them to book them for a show or private event. 
...
The people most likely to utilize this application will be live music lovers, specifically those who love covers of popular music. Currently, members of the band do not have as much difficulty contact venues like bars and restaurants to book shows to play live. They have expressed a desire to expand their reach into the private party bookings. This necessitates a different need in what they display and use to hook in someone looking to book a band for an event or party they are hosting.
...
Name: Ellis Tipton
Occupation: Wedding/Event Planner at "Tip Top Events"
Location: Columbus, GA
Experience: 10 years in event planning, 200+ weddings completed, 100+ events coordinated
Bio: Runs a small wedding and event planning company that specializes in using as many local vendors and talent as possible.
...
It saves the user time in finding talent and coordinating booking an event. It also allows the user to research and decide if the band is the right fit for the event.
...
Pain points include lack of responsiveness and lack of ease in finding information. They wants contact info, style info, and at least basic booking info before starting their inquiry.
...
This project will have all of the necessary information readily available as well as an easy contact method to pursue booking.
...
Social media sites are the primary competition. However, they can easily be ignored and forgotten making them unreliable.
...
About Page: A bio of the band and a description of the type of music they can and will play as well as basic booking information (like cost and equipments necessities, etc).
Show Dates: A list of currently booked dates to know if the band is available on the date in question.
Demo: A page of videos and pictures to show what the band is about and check out the sound.
Booking contact: An easy to submit form to contact the band and book them.
...
I have not fully formed this yet as I think it will be upon necessity of function as I build the project. I plan to start with my own API based on the tech stack information listed previously.